...
export function PillVisualization({ shape, size, color1, color2, className = '' }: PillVisualizationProps) {
  const sizeMap = {
    S: { capsule: 'w-6 h-10', round: 'w-10 h-10', square: 'w-10 h-10', triangular: 'w-10 h-10' },
  ...
  if (shape === 'capsule') {
    return (
      <div className={`${sizeClass} rounded-full overflow-hidden flex flex-col border-2 border-black ${className}`}>
  ...
  if (shape === 'round') {
    return (
      <div className={`${sizeClass} rounded-full overflow-hidden flex border-2 border-black ${className}`}>
        <div className="flex-1" style={{ backgroundColor: color1 }} />
        <div className="flex-1" style={{ backgroundColor: color2 }} />
      </div>
    );
  ...
  if (shape === 'square') {
    return (
      <div className={`${sizeClass} rounded-2xl overflow-hidden flex border-2 border-black ${className}`}>
        <div className="flex-1" style={{ backgroundColor: color1 }} />
        <div className="flex-1" style={{ backgroundColor: color2 }} />
      </div>
    );
