        ...
        <div className="bg-[rgb(var(--color-surface))] rounded-2xl p-6 border border-[rgb(var(--color-border))]">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-[rgb(var(--color-text-secondary))] mb-4">
                Usamos localização aproximada para combinar seu humor com clima e temperatura locais.
              </p>
              <button
                onClick={() => setLocationEnabled(!locationEnabled)}
                className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors ${
                  locationEnabled ? 'bg-[rgb(var(--color-primary))]' : 'bg-[rgb(var(--color-gray-300))]'
                }`}
              >
                <span
                  className={`inline-block h-6 w-6 transform rounded-full bg-white transition-transform ${
